    ...
    <div className="p-6 w-full h-full grid place-content-center">
      <div className="max-w-xl md:text-center">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,_6.5rem)] justify-start md:justify-center gap-4 mx-auto">
          <Link
            className="p-3 text-green-400 border border-green-500 rounded-full hover:bg-green-400 hover:text-green-950 active:bg-green-500 active:scale-95 transition hover:font-bold text-center"
            to="signup"
            role="button"
          >Sign up</Link>
          <Link
